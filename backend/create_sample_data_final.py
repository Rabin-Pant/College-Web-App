...
with app.app_context():
    ...
    # 9. Create a sample assignment - USING SECTION_ID (not class_id)
    cursor.execute("""
    ...
    print(f"✅ Assignment created with ID: {assignment_id} (using section_id)")
    
    # 10. Upload sample material - USING SECTION_ID
    cursor.execute("""
    ...
    print(f"✅ Material uploaded (using section_id)")
