...
with app.app_context():
    ...
    if not teacher:
        ...
        print(f"✅ Teacher user created with ID: {teacher_user_id}")
    else:
        teacher_user_id = teacher['id']
        print(f"✅ Teacher user exists with ID: {teacher_user_id}")
    ...
    if not teacher_profile:
        ...
        print(f"✅ Teacher profile created with ID: {teacher_profile_id}")
    else:
        teacher_profile_id = teacher_profile['id']
        print(f"✅ Teacher profile exists with ID: {teacher_profile_id}")
    ...
    print(f"✅ Material uploaded (using teacher_profile_id: {teacher_profile_id})")
